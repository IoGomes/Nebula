...
public class Dialog_Feed_03_Long_Hold_Options extends Dialog {
    public Dialog_Feed_03_Long_Hold_Options(@NonNull Context context) {

        super(context);

        setContentView(R.layout.dialog_07_longhold_options);
