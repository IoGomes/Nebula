...
import static Nebula.Android.Nebula_View.RV_Adapters.RV_Feed_02_Contact_Adapter.Adapter_Mode.MODE_B;
...
public class Dialog_Feed_Choose_Contact extends Dialog {
    ...
    public Dialog_Feed_Choose_Contact(@NonNull Context context, List<Entity_Contact> contacts) {
        super(context);
        ...
        adapter = new RV_Feed_02_Contact_Adapter(contacts, MODE_B);
