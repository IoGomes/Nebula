...
public class Dialog_Feed_05_Add_Contact extends Dialog {

    private Dlg09AddContactBinding bind;
    private Activity activity;
    private List<Entity_06_Contact> contactsList;

    public Dialog_Feed_05_Add_Contact(@NonNull Context context, List<Entity_06_Contact> contactsList) {
        super(context);
    ...
    private void init() {
        bind.btnSave.setOnClickListener(v -> {
            ...
            if (!name.isEmpty() && !phoneNumber.isEmpty()) {
                Entity_06_Contact newContact = new Entity_06_Contact(name, phoneNumber);
